VERSION 5.00
Begin VB.Form QueryProductosInv 
   ...
   Begin Proyecto1.OsenXPButton OsenXPButton1 
      ...
      MCOL            =   12632256
      MPTR            =   0
      MICON           =   "QueryProductosInv.frx":0000
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin VB.Image Image2 
      Height          =   720
      Left            =   240
      Picture         =   "QueryProductosInv.frx":001C
      Top             =   120
      Width           =   735
   End
   ...
   End
End
Attribute VB_Name = "QueryProductosInv"
...
If optbarkod.Value = True Then
   sSql = "Select * from TBL_Producto Order By Codigo_Producto"
Else
...
Set RptProductos.DataSource = VrsProductosActual
RptProductos.Sections("S1").Controls("Label15").Caption = Funciones.CurrUser.USER_NAME
RptProductos.Show 1
RAE:
